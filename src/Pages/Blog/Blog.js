...
const Blog = () => {
    return (
        <div className=' w-3/5 m-auto py-10'>
            <h2 className='text-3xl'>1. Difference between SQL and MYSQL ?</h2>
            ...
            <h2 className='text-3xl'>2. What is jwt and how does work it ?</h2>
            ...
            <h2 className='text-3xl'>1. What is the difference between javascript and nodeJs</h2>
            ...
            <h2 className='text-3xl'>1. How does node js handle multiple request at the same time</h2>
